...
import com.shine.order.dao.OmsOrderReturnReasonDao;
import com.shine.order.entity.OmsOrderReturnReasonEntity;
import com.shine.order.service.OmsOrderReturnReasonService;
...
public class OmsOrderReturnReasonServiceImpl extends ServiceImpl<OmsOrderReturnReasonDao, OmsOrderReturnReasonEntity> implements OmsOrderReturnReasonService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<OmsOrderReturnReasonEntity> page = this.page(
                new Query<OmsOrderReturnReasonEntity>(params).getPage(),
