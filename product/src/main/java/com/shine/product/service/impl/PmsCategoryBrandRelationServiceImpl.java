...
import com.shine.product.dao.PmsCategoryBrandRelationDao;
import com.shine.product.entity.PmsCategoryBrandRelationEntity;
import com.shine.product.service.PmsCategoryBrandRelationService;
...
public class PmsCategoryBrandRelationServiceImpl extends ServiceImpl<PmsCategoryBrandRelationDao, PmsCategoryBrandRelationEntity> implements PmsCategoryBrandRelationService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<PmsCategoryBrandRelationEntity> page = this.page(
                new Query<PmsCategoryBrandRelationEntity>(params).getPage(),
