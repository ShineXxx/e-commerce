...
import com.shine.product.dao.PmsCommentReplayDao;
import com.shine.product.entity.PmsCommentReplayEntity;
import com.shine.product.service.PmsCommentReplayService;
...
public class PmsCommentReplayServiceImpl extends ServiceImpl<PmsCommentReplayDao, PmsCommentReplayEntity> implements PmsCommentReplayService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        IPage<PmsCommentReplayEntity> page = this.page(
                new Query<PmsCommentReplayEntity>(params).getPage(),
